...
MessageBox::MessageBox(SDL_Renderer* r, std::string title, std::string message, std::function<void()> f) {
	...
	okButton = new Button(r, int(Width * 0.67), int(Height * 0.66), int(Width * 0.09), int(Height * 0.055), "OK", 32, bottom_right, f, SDLK_RETURN);
}
