...
PauseMenu::PauseMenu(MainWindow& mw, std::function<void()> fp, std::function<void()> UnpauseF,
    ...
    AddDrawable<Button>(mw, int(Width * 0.34), int(Height * 0.35), int(Width * 0.12), int(Height * 0.06), "Back", fontSize,
                        UnpauseF);
    AddDrawable<Button>(mw, int(Width * 0.34), int(Height * 0.45), int(Width * 0.12), int(Height * 0.06), "Save Game", fontSize);
    AddDrawable<Button>(mw, int(Width * 0.34), int(Height * 0.55), int(Width * 0.12), int(Height * 0.06), "Resign", fontSize,
                        change);
