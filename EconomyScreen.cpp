...
EconomyScreen::EconomyScreen(SDL_Renderer* r, int Width, int Height, Country* Pl, std::function<void()> fp, std::function<void(Screen*)> fpl) : Screen(r, Width, Height) {
	bHasBackground = true;
	...
	l1 = "Healthcare: ", std::to_string(Pl->Policy.TaxRate), "%";
