#ifndef GOODSLAYOUT_H
#define GOODSLAYOUT_H

#include "game/PerGood.h"

#include <array>

namespace GoodsLayout {
...
inline constexpr int ArtWidth = 1920;
inline constexpr int ArtHeight = 1080;
...
plaque painted onto the background. The Industry screen writes what the
country holds on the plaques and the Trade screen what each good costs.*/
inline constexpr std::array<StockpileLabel, 38> Layout{{
