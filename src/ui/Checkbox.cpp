...
Checkbox::Checkbox(MainWindow& mw, int x, int y, int Height, std::string text, FontSize textSize, std::function<void(bool)> f, int keybind) : Checkbox(mw, x, y, Height, text, textSize, top_left, f, keybind) {}

Checkbox::Checkbox(MainWindow& mw, int x, int y, int Height, std::string text, FontSize textSize, [[maybe_unused]] Anchor anchor, std::function<void(bool)> f, int keybind) :
...
void Checkbox::ChangeTextSize(FontSize size) {
